            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Enter slider title" value="{{ $slider->title }}">
                        <span class="text-danger">{{ $errors->first('title') }}</span>
                    </div>

                    <div class="form-group">
                        <label for="">Slider Description (optional)</label>
                        <textarea name="description" placeholder="Enter Slider Description" class="form-control" rows="5">{{ $slider->description }}</textarea>
                ...
                <div class="box-footer">
                    <button class="btn btn-sm btn-primary" onclick="submit_form(this, event)">Update Slider</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
