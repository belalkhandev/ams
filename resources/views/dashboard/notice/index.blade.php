        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{ route('notice.create') }}" class="btn btn-sm btn-primary float-right">Crate new</a>
                </div>
                <div class="box-body">
                    <table class="table">
                        <thead>
                                ...
                                @foreach ($notices as $key => $notice)
                                    <tr>
                                        ...
                                        <td class="inline-element">
                                            <a href="{{ route('notice.edit', $notice->id) }}" data-toggle="tooltip" title="Delete" data-placement="top" class="custom-btn-sm btn btn-primary"><i class="fas fa-edit"></i></a>
