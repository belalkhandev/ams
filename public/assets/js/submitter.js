                ...
                if (ret.autoload && res) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            let post = '<div class="post-box">'+
                            '<div class="post-header">'+
                                '<div class="author-img">'+
                                    '<img src="'+result.user_image+'" alt="">'+
                                '</div>'+
                               ' <div class="author">'+
                                    '<h2>'+result.user_name+'</h2>' +
                                    '<p class="post-time" data-post_time="'+result.post.created_at+'">'+result.post.post_time+'</p>'+
                                '</div>'+
                            '</div>'+
                            '<div class="post-body">'+result.post.content+'</div>'+                            
                            '<div class="post-footer">'+
                                '<h5>Comments</h5>'+
                            '</div>'+
                        '</div>';
                            $('#classroomPost').prepend(post);
                        }
                    });
                }
